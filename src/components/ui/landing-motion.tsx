    ...
    const setup = () => {
      ...
      const targets = Array.from(
        document.querySelectorAll<HTMLElement>(
          ".section .section-heading, .vehicle-showcase, .process-track > li, .process-note, .cost-document, .estimate-form, .time-value, .timing-bottom, .contracts-visual, .delivery-route > li, .interior-figure, .advantages-list > li, .faq-list, .final-inner",
        ),
      );
