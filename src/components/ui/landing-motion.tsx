    ...
    const setup = () => {
      ...
      const targets = Array.from(
        document.querySelectorAll<HTMLElement>(
          ".section .section-heading, .vehicle-showcase, .russia-selection-list > li, .process-track > li, .process-note, .cost-document, .recycling-guide, .direction-card, .machinery-gallery-panel, .estimate-form, .time-value, .timing-bottom, .contracts-visual, .delivery-route > li, .interior-figure, .advantages-list > li, .faq-list, .final-inner",
        ),
      );
